        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <label className="flex items-center gap-2 text-sm">
            ...
            <input
              ...
              className="px-3 py-2 rounded-xl border border-warm-200 bg-paper w-28 text-sm focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none"
            />
          </label>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-5 pt-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex gap-2 flex-1">
                  <input
                    ...
                    className="flex-1 px-3.5 py-2.5 rounded-xl border border-warm-200 bg-paper text-sm focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none"
                  />
                  <button
                    onClick={() => {
                      addChild(newName);
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-[var(--accent-500)] hover:bg-[var(--accent-600)] text-white rounded-xl text-sm font-medium whitespace-nowrap shadow-sm"
                  >
        ...
        <section className={`bg-paper rounded-2xl p-6 shadow-card ${sampleMode ? "opacity-60 pointer-events-none" : ""}`}>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-3.5 py-2.5 rounded-xl border border-warm-200 bg-paper text-sm leading-relaxed focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none resize-none"
          />
        ...
        <section className="bg-paper rounded-2xl p-6 shadow-card">
            ...
            {(Object.keys(TONE_LABELS[docType]) as ToneStyle[]).map((t) => (
              <label
                ...
                className={`px-3.5 py-1.5 rounded-full border text-sm cursor-pointer transition ${
                  tone === t
                    ? "bg-[var(--accent-500)] text-white border-[var(--accent-500)] shadow-sm"
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[var(--accent-500)] hover:bg-[var(--accent-600)] text-white rounded-2xl font-semibold disabled:bg-warm-200 disabled:text-ink-faint disabled:cursor-not-allowed shadow-sm hover:shadow-md"
          >
                ...
                return (
                  ...
                  >
                    <div className="flex items-baseline justify-between mb-2">
                      ...
                      <button
                        onClick={() => copy(c.id)}
                        className="inline-flex items-center gap-1 text-xs px-2 py-1 text-ink-muted hover:text-[var(--accent-600)]"
                      >
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 px-3 py-2.5">
      <input
        ...
        className="flex-1 min-w-[8rem] px-3 py-1.5 rounded-lg border border-warm-200 bg-paper text-sm focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none"
      />
      {last && (
      ...
      <button
        ...
        className="text-xs px-2.5 py-1 rounded-lg bg-[var(--accent-500)] hover:bg-[var(--accent-600)] text-white disabled:bg-warm-200 disabled:text-ink-faint disabled:cursor-not-allowed"
      >
        저장
      </button>
      <button
    ...
    <div className="rounded-2xl p-3.5 bg-cream-50">
      ...
      {isGwanchal ? (
        <textarea
          ...
          rows={2}
          className="w-full px-3 py-2 text-sm rounded-xl border border-warm-200 bg-paper focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none resize-none"
        />
      ) : (
        <input
          value={entry.memo}
          onChange={(e) => onChange({ memo: e.target.value })}
          placeholder={placeholder}
          className="w-full px-3 py-2 text-sm rounded-xl border border-warm-200 bg-paper focus:border-[var(--accent-400)] focus:ring-2 focus:ring-[var(--accent-100)] focus:outline-none"
        />
      )}
    </div>
  );
  ...
  return (
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-3">
        <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[var(--accent-50)] text-[var(--accent-700)] text-sm font-semibold tabular-nums">
          {step}
        </span>

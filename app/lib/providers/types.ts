...
export const MODEL_CHOICES: Record<ProviderId, ModelChoice[]> = {
  ...
  gemini: [
    { id: "gemini-2.0-flash", label: "Gemini 2.0 Flash (제미나이 2.0 플래시)", note: "빠르고 저렴 (추천)" },
    { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash (제미나이 2.5 플래시)", note: "균형형" },
    { id: "gemini-2.5-pro", label: "Gemini 2.5 Pro (제미나이 2.5 프로)", note: "고품질" },
  ],
};
